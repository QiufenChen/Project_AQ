...
def Train(net, all_data, learning_rate, batch_size, max_epochs, output_freq, device):
    ...
    print("PID:      ", os.getpid())
    print("# of training graphs/labels: %d" % (num))
    ...
    for epoch in range(max_epochs + 1):
        ...
        with th.no_grad():
            ...
            if test_mae <= MinValMae:
                ...
                #model = BestModel
                #th.save(model.state_dict(), 'solubNet1.pt')
        # th.cuda.empty_cache()
