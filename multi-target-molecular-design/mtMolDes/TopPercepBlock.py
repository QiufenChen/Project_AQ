...
class TopPercepBlock(nn.Module):
    ...
    def __init__(self, num_features, num_labels, features_str):
        ...
        """
        super(TopPercepBlock, self).__init__()
        # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # #
        ...
        self.gcn_layers.append(TAGConv(num_hiddens, num_labels, activation=nn.ReLU()))
        ...
        # self.gcn_layers.append(GraphConv(num_hiddens, num_labels))
        ...
        # self.gcn_layers.append(GATConv(num_hiddens, num_labels, num_heads=1))
