...
def Train(net, data_train, data_test, learning_rate, batch_size, max_epochs, output_freq, device):
    ...
    print("%10s %15s %15s %15s %15s %15s %15s %15s %15s %15s %15s %15s" %
          ("Epoch", "TrainLoss", "TrainMAE", "TrainRMSE", "TrainR2", "TrainCC",
           "TestLoss", "TestMAE", "TestRMSE", "TestR2", "TestCC", "Time(s)"))
    print(separator)
    ...
    for epoch in range(max_epochs + 1):
        ...
        with th.no_grad():
            ...
            print("%10d %15.3f %15.3f %15.3f %15.3f %15.3f %15.3f %15.3f %15.3f %15.3f %15.3f %15.3f" %
                  (epoch, train_loss, train_mae, train_rmse, train_r2, train_cc, test_loss, test_mae, test_rmse, test_r2, test_cc, dur))
