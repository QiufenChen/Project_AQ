...
class TencentAlchemyDataset(Dataset):
    ...
    RDConfig.RDDataDir = '/lustre/home/qfchen/anaconda3/envs/RDKit/share/RDKit/Data'
    ...
    def smi_to_dgl(self, index, self_loop=False):
        ...
        AllChem.Compute2DCoords(mol) # 计算分子的2D坐标函数解析
        g = dgl.DGLGraph()
    ...
    def _load(self):
        if self.mode == 'Train':
            ...
            # self.target = pd.read_csv(target_file, usecols=[0,1], encoding='utf-8', header=-1)
